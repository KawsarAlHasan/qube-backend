...
async function main() {
    try {
        mongoose_1.default.connect(index_1.default.database_url);
        logger_1.logger.info(colors_1.default.green('🚀 Database connected successfully'));
        const port = typeof index_1.default.port === 'number' ? index_1.default.port : Number(index_1.default.port);
        server = app_1.default.listen(port, index_1.default.ip_address, () => {
            logger_1.logger.info(colors_1.default.yellow(`♻️  Application listening on port:${index_1.default.port}`));
        });
        //socket
